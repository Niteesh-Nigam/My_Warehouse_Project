...
: ${AMENT_CURRENT_PREFIX:="/home/nitzz/my_warehouse_project/install/warehouse_camera"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/warehouse_camera/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/warehouse_camera/environment/path.sh"
